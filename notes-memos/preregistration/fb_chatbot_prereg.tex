...
\begin{tabular}{p{.3\textwidth}  l}
  ...
  \raggedright
What would you say is the \textbf{main} reason you are hesitant to get the COVID-19 vaccine? & 
...
\item Misinfo (africa check video)
\item elite cues (WHO)
...
\item Misinfo (Africa check video) \vspace*{-\baselineskip}
...
After respondents report their primary concern, we deliver messaging targeted to that concern. In the learning phase treatment is assigned randomly within the set of treatments targeting that particular concern, as outlined in Table 1. In the evaluation phase, the top performing treatment(s) in each category will be assigned for each concern. \todo{note section here}
